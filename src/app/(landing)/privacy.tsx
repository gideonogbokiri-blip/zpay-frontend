...
import { PRIVACY_POLICY, PRIVACY_TITLE } from '@/constants/legal';
...
export default function PrivacyScreen() {
  ...
  return (
    <Screen title={PRIVACY_TITLE} back scroll>
      ...
      <Text variant="caption" color="textMuted" style={styles.note}>
        For privacy questions, contact support at support@zpay.app.
      </Text>
    </Screen>
  );
}
