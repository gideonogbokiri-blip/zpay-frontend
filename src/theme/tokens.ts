...
export const palette = {
  ...
  zpayAccent: '#00C54C',
  zpayAccentDark: '#00A93F',
  zpayBrandBlue: '#4ADE80',
  zpayBrandLavender: '#86EFAC',
  white: '#FFFFFF',
  gray50: '#F5F6F8',
  gray100: '#EAECEF',
  gray200: '#D6D9DD',
...
export const darkColors: ThemeColors = {
  ...
  accentSoft: 'rgba(0, 197, 76, 0.16)',
  brand: palette.zpayAccent,
  white: palette.white,
  text: palette.white,
  textSecondary: palette.gray100,
  textMuted: palette.gray400,
  success: palette.zpayAccent,
  successSoft: 'rgba(0, 197, 76, 0.16)',
  danger: palette.red,
